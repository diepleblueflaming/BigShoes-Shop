<?php $this->load->view("admin/size/head")?>
<div class="content">
<div class="row">
    <div class="col-xs-12">
    ...
    <div class="box">
        <div class="box-header">
            <h3 class="box-title">Bảng Thông Tin Kích Thước</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="dataTables_length" id="example1_length"><label>
                            <form action="<?php echo base_url("admin/size/")?>" method="post">Hiển Thị
                    ...
                    <div class="col-sm-6">
                        <div class="dataTables_filter">
                            <label>
                                <label>
                                    <input class="form-control input-sm" placeholder="Nhập Kích Thước"  type="search" name="search">
                                </label>
                            </label>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-3 dataTables_filter">
                        <a class="btn btn-success btn-flat" href="<?php echo base_url("admin/size/add/")?>">
                        ...
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <?php foreach($list as $it):?>
                                <tr role="row" id="rows_<?php echo $it->id?>" class="tr_check">
                                    ...
                                    <td>
                                        <a href="<?php echo base_url("admin/size/delete/".$it->id)?>" title="Xóa" class="req"><span class="fa fa-remove"></span></a> |
                                        <a href="<?php echo base_url("admin/size/edit/".$it->id)?>" title="Sửa"><span class="fa fa-edit"></span></a>
                                    </td>
                                </tr>
                            <?php endforeach?>
                            </tbody>
