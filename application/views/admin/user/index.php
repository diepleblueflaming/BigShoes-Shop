                ...
                <div class="row">
                    <div class="col-sm-3">
                        <div class="dataTables_length" id="example1_length"><label>
                            <form action="<?php echo base_url("admin/user/")?>" method="post">Hiển Thị
                        ...
                        <table id="myTable" class="table table-bordered table-striped">
                            ...
                            <?php foreach($list as $it) : ?>
                                <tr role="row" id="rows_<?php echo $it->id?>" class="tr_check">
                                    ...
                                    <td><?=!$it->active ? "<span class='fa fa-check'></span>" : "<span class='fa fa-exclamation-triangle'></span>" ?></td>
                                    <td><a href="<?php echo base_url("admin/user/delete/".$it->id)?>" title="Xóa" class="req"><span class="fa fa-remove"></span></a></td>
                                </tr>
