                                    ...
                                    <tr ng-repeat="item in carts" ng-init="options=item['options']">
                                        ...
                                        <td class="td-content">
                                            ...
                                            <div class="color_container">
                                                ...
                                                <span class="color active" id="{{color.name+'-'+color.id}}"></span>
                                                <div class="list_color">
                                                    <span class="color" ng-repeat="c in options['colors']" id="{{c.name+'-'+c.id}}" ng-click="changeData(item.id,c,'color')"></span>
                                                </div>
                                            </div>
