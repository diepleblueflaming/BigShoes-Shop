...
<div class="container">
    <div id="path">
        <a href="<?=base_url()?>">Home</a> &gt; <?=$catalog ? $catalog->getTitle() : "" ?>
    </div>

    <div class="wrapper">
        <!-- article left -->
            <div class="col-xs-12 col-sm-4 col-md-3" id="session-left">
            <!-- navbar left -->
        ...
        <!-- article  right -->
            <div class="col-xs-12 col-sm-8 col-md-9" id="article-right">
        <!-- phan loc san pham -->
            <div class="filter">
